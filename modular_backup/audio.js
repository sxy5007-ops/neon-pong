...
(function () {
  ...
  function setMute(muted) {
    ...
    NP.ui.muteBtn.textContent = icon;
    NP.ui.hudMuteBtn.textContent = icon;
  }
  ...
  NP.AudioEngine = { init: init, setMute: setMute, toggleMute: toggleMute,
    sfxPaddleHit: sfxPaddleHit, sfxWallHit: sfxWallHit, sfxScore: sfxScore,
    sfxWin: sfxWin, startMusic: startMusic, stopMusic: stopMusic };
