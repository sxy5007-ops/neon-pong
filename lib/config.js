...
(function () {
  ...
  NP.config = {
    ...
    WORM_SPEED: 100,
    WORM_PATROL_MARGIN: 30,
    WORM_EJECT_SPEED: 600,
    WORM_EJECT_DELAY: 0.3,
  ...
  /* == Campaign Levels == */
  NP.config.CAMPAIGN_LEVELS = [
    {
      id: 'tutorial', title: 'WARM UP', subtitle: 'TUTORIAL',
      winScore: 3, difficulty: 'easy', initialSpeed: 400,
      description: 'Learn the basics of Neon Pong.',
      powerUps: ['mega', 'tiny', 'turbo'], hazards: [],
    },
    {
      id: 'powerplay', title: 'POWER PLAY', subtitle: 'MASTER THE BOOSTS',
      winScore: 5, difficulty: 'easy',
      description: 'All power-ups are yours to master.',
      powerUps: true, hazards: [],
    },
    {
      id: 'bouncehouse', title: 'BOUNCE HOUSE', subtitle: 'WATCH YOUR ANGLES',
      winScore: 7, difficulty: 'normal',
      description: 'Bumpers join the field.',
      powerUps: true, hazards: ['bumpers'],
    },
    {
      id: 'stormfront', title: 'STORM FRONT', subtitle: 'NEON LIGHTNING',
      winScore: 7, difficulty: 'normal',
      description: 'A violent neon storm rages across the arena.',
      powerUps: true, hazards: ['bumpers', 'storm'],
    },
    {
      id: 'wormbreach', title: 'WORM BREACH', subtitle: 'DATA HUNTER',
      winScore: 7, difficulty: 'normal',
      description: 'The data worm has breached the system.',
      powerUps: true, hazards: ['bumpers', 'worm'],
    },
    {
      id: 'chaos', title: 'CHAOS THEORY', subtitle: 'EVERYTHING AT ONCE',
      winScore: 10, difficulty: 'hard',
      description: 'Every hazard, every power-up. Survive.',
      powerUps: true, hazards: ['bumpers', 'worm', 'storm', 'kaiju', 'disco', 'tornado'],
    },
    {
      id: 'kaijuking', title: 'KAIJU KING', subtitle: 'TITAN CONFLICT',
      winScore: 10, difficulty: 'hard',
      description: 'Kaiju and worm together. Good luck.',
      powerUps: true, hazards: ['bumpers', 'worm', 'kaiju'],
    },
    {
      id: 'finalfrontier', title: 'FINAL FRONTIER', subtitle: 'THE GAUNTLET',
      winScore: 15, difficulty: 'hard', initialSpeed: 520, maxSpeed: 1200,
      description: 'Maximum speed, every hazard. Prove yourself.',
      powerUps: true, hazards: ['bumpers', 'worm', 'storm', 'kaiju', 'disco', 'tornado'],
    },
  ];
