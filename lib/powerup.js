...
(function () {
  ...
  function applyPowerUp(owner, type) {
    ...
    if (NP.AudioEngine.sfxCallout) NP.AudioEngine.sfxCallout('BOOST');
    ...
    if (type === 'random') {
      // Pick a random power-up (excluding random itself) and apply it
      ...
      // The recursive call above handles callout, particles, shake, and effectUI
      // We return early to avoid duplicating that work
      return;
    }
